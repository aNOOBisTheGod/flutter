...
vars = {
  ...
  'dart_revision': '1ab79388c537e7332d6c53810bc2323c6a47d9e6',
  ...
  'dart_pub_git': 'https://github.com/aNOOBisTheGod/pub.git',
  'dart_pub_rev': 'e7f5fc340b66edfc8f663f9c0dde2d8e2f53f04f',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart':
   'https://github.com/aNOOBisTheGod/dart-sdk.git' + '@' + Var('dart_revision'),
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/pub':
   Var('dart_pub_git') + '@' + Var('dart_pub_rev'),
